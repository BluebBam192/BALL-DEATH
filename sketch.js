...
function draw() {
  ...
  if(gameState==="WAIT"){
    ...
    text("YOU WILL BE HAVING A SCORE AND A LIFE COUNT ON YOUR SCREEN. WHEN THE LIFE COUNT GOES TO ZERO THE GAME FINISHES.",100,200);
    text("DURING THE GAME YOU WILL BE HAVING FEW HEARTS ON THE WAY. ONCE YOU ARE OUT REFRESH THE PAGE TO START AGAIN",400,500);
